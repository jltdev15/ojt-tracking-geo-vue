    ...
    <div class="p-6">
        <div class="py-3 text-sm breadcrumbs">
            <ul>
                ...
                <li>
                    <router-link class="font-medium" :to="{ name: 'Hte_Listing' }">HTE Listings</router-link>
                </li>
        ...
        <section class="">
            ...
            <EasyDataTable :headers="headers" :items="userStore.vacancyList" :search-field="searchField"
