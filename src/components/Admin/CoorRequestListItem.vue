    ...
    <div>
        <div class="p-6 text-sm breadcrumbs">
            <ul>
                ...
                <li>
                    <router-link class="" :to="{ name: 'CoordinatorList' }">Coordinator</router-link>
                </li>
                <li>
                    <router-link class="font-bold" :to="{ name: 'CoordinatorRequestItem' }">Request List</router-link>
                </li>
            </ul>
        </div>
        ...
        <div class="px-6">
            <EasyDataTable :headers="headers" :items="adminUserStore.coorRequestList" :search-field="searchField"
