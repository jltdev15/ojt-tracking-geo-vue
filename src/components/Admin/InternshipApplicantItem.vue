    ...
    <div>
        <section class="p-3">
            ...
            <div class="flex justify-end gap-3 py-3">
                <input type="text" placeholder="Search here" class="w-full input input-bordered"
                    v-model="searchValue" />
            ...
            <EasyDataTable :headers="headers" :items="hteStore.applicantItemList" :search-field="searchField"
