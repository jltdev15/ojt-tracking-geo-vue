<template>
  ...
  >
    ...
    <ul class="mt-4">
      ...
      <li class="mb-1 group transition">
        <span
        ...
        >
          ...
          <i
            class="ml-auto ri-arrow-right-s-line transition-all"
            :class="{ 'rotate-90': isDropDownShow, 'rotate-260': !isDropDownShow }"
          ></i>
        </span>

        <ul
          :class="{ 'h-0 hidden': !isDropDownShow, block: isDropDownShow }"
          class="pl-7 mt-2 transition-all"
        >
          <li class="mb-4">
            <router-link
              :to="{ name: 'manage_users', query: { users: 'All' } }"
              href=""
          ...
          <li class="mb-4">
            <router-link
              :to="{ name: 'manage_users', query: { users: 'Coordinator' } }"
              href=""
              class="text-gray-900 text-sm flex items-center hover:text-[#f84525] before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3"
