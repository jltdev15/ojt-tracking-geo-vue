  ...
  <section class="p-3">
    <div class="py-6 text-sm md:p-6 breadcrumbs">
      <ul>
        ...
        <li>
          <router-link :to="{ name: 'manage_users', query: { users: 'All' } }">Manage users</router-link>
        </li>
      </ul>
    </div>
    <header class="flex items-center justify-between gap-3 bg-gray-200 md:px-6 md:flex-row md:justify-between">
      <h1 class="md:text-3xl">
        User <span class="font-bold md:text-3xl">Management</span> -
        {{ route.query.users === "Coordinator" ? "Coor" : route.query.users }}
      </h1>
      <div>
    ...
    <div class="flex justify-end gap-3 py-3 md:px-6">
        ...
        <div>
          ...
          <div v-if="selectedRole === 'HTE'" class="grid grid-cols-2 gap-3 pt-3">
            ...
            <div class="flex flex-col w-full gap-3">
              ...
              <div class="flex gap-3">
                ...
                <label class="flex items-center w-full gap-2 input input-bordered">
                  <input v-model="hte.contact" type="number" class="grow" placeholder="Contact number" minlength="11"
              ...
              <div class="flex gap-3">
                ...
                <label class="flex items-center w-full gap-2 input input-bordered">
                  <input v-model="hte.street" type="text" class="grow" placeholder="Street/House Number" />
                </label>
              </div>
            ...
            <div class="flex flex-col gap-3">
              ...
              <label class="flex items-center gap-2 input input-bordered">
                <input v-model="hte.mapLocation.lat" type="number" class="w-full" placeholder="Latitude" readonly />
                <input v-model="hte.mapLocation.lng" type="number" class="w-full" placeholder="Longtitude" readonly />
              </label>
              ...
              <div v-if="isMapShow" id="map" style="height: 300px; width: 100%; margin-top: 20px"></div>
            </div>
          </div>
          <div v-if="selectedRole === 'Coordinator'" class="flex flex-col gap-3 pt-3">
            ...
            <div class="flex gap-6">
              <label class="flex items-center w-full gap-2 input input-bordered">
                <input v-model="coordinator.firstName" type="text" class="grow" placeholder="Coordinator First Name" />
              </label>
              <label class="flex items-center w-full gap-2 input input-bordered">
                <input v-model="coordinator.lastName" type="text" class="grow" placeholder="Coordinator Last Name" />
              </label>
            </div>
            <div class="flex gap-6">
              <label class="flex items-center w-full gap-2 input input-bordered">
              ...
              <label class="flex items-center w-full gap-2 input input-bordered">
                <input v-model="coordinator.contactNumber" type="number" class="grow" placeholder="Contact number"
                  minlength="11" maxlength="11" pattern="\d{11}" />
              </label>
            </div>

            <div class="flex gap-6">
              <select class="w-full select select-bordered md:max-w-xs" v-model="selectedProvince"
              ...
              <select class="w-full select select-bordered md:max-w-md" v-model="selectedMunicipality"
                @change="onSelectMunicipality">
                <option selected disabled>Municipality/City</option>
                <option v-for="item in municipality" :key="item" :value="item">
                  {{ item.name }}
