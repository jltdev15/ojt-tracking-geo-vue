          ...
          <div>
            ...
            <div v-if="selectedRole === 'HTE'" class="grid gap-3 pt-3 overflow-y-auto md:grid-cols-2">
              ...
              <div class="flex flex-col w-full gap-3">
                ...
                <div class="flex flex-col gap-3 ">
                  ...
                  <label class="flex items-center w-full gap-2 input input-bordered">
                    <input v-model="hte.contact" type="number" class="grow" placeholder="Contact number" />
                  </label>
                </div>
                ...
                <div class="flex gap-3 md:flex-row">
                  <select class="w-3/6 md:w-full select select-bordered" v-model="selectedBrgy" @change="onSelectBrgy">
              ...
              <div class="flex flex-row-reverse col-span-2 gap-2 md:mt-auto">
                ...
                <button @click="handleHteUser" class="w-32 btn btn-primary ">
                  Create User
                </button>
                <button class="w-32 text-lg btn btn-accent btn-outline" @click="handleToggleModal">
                  Close
                </button>
...
const handleCoorUser = async () => {
  ...
  if (coordinator.contactNumber.length != 10) {
    return alert("Please enter complete contact number");
  }
