      ...
      <div class="flex flex-col gap-3 bg-white rounded-md shadow-md">
        ...
        <section v-if="userStore.currentRole === 'Coordinator'" class="grid p-3 md:p-6 md:grid-cols-2 gap-x-6">
          <div class="flex flex-col gap-3">
            ...
            <div>
              ...
              <input v-model="userStore.updateInfo.contactNumber" minlength="11" maxlength="11" type="number"
        ...
        <section v-if="userStore.currentRole === 'Intern'" class="grid w-full p-3 md:p-6 md:grid-cols-2 gap-x-6">
          <div class="flex flex-col gap-3">
            ...
            <div>
              <label for="">Contact Number</label>
              <input v-model="userStore.updateInfo.internContact" minlength="10" maxlength="10" type="number"
          ...
          <div class="flex justify-between w-full gap-3 mt-6 ml-auto md:justify-end md:col-span-2">
            <router-link :to="{ name: 'manage_users', query: { users: 'Intern' } }"
