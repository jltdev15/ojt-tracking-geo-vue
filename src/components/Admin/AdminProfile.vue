<template>
    <div class="px-6 mx-auto md:w-9/12">
            ...
            <section class="grid p-6 bg-white rounded-md shadow-md md:gap-6 md:grid-cols-2">
                ...
                <div class="flex flex-col gap-2">
                    <div>
                        ...
                        <input type="text" v-model="authStore.adminInformation.firstName" placeholder="Type here"
                            class="w-full md:max-w-md input md:input-sm xl:input-md input-bordered" required />
                    </div>
                    <div>
                        <label class="block" for="">Last Name</label>
                        <input type="text" v-model="authStore.adminInformation.lastName" placeholder="Type here"
                            class="w-full md:max-w-md input md:input-sm xl:input-md input-bordered" required />
                    </div>
                    <div>
                        <label class="block" for="">Email</label>
                        <input type="text" v-model="authStore.adminInformation.email" placeholder="Type here"
                            class="w-full md:max-w-md input xl:input-md md:input-sm input-bordered" required />
                    </div>
                    <div>
                        <label class="block" for="">Contact</label>
                        <input v-model="authStore.adminInformation.contact" placeholder="Type here"
                            class="w-full md:max-w-md input input-sm xl:input-md input-bordered" minlength="10"
                            maxlength="10" type="number" pattern="\d{10}" required />
                    </div>
                </div>
                <!-- right side -->
                <div class="flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <select class="w-full select md:select-sm xl:select-md select-bordered md:max-w-md"
                            v-model="selectedProvinces" @change="onSelectProvince">
                            <option value="" selected>{{ authStore.adminInformation.province ?
                    ...
                    <div>
                        ...
                        <select class="w-full select md:select-sm xl:select-md select-bordered md:max-w-md"
                            ...
                            <option selected value="">{{ authStore.adminInformation.municipality ?
                                authStore.adminInformation.municipality : 'Select Municipality' }}</option>
                    ...
                    <div>
                        ...
                        <select class="w-full select md:select-sm select-bordered xl:select-md md:max-w-md"
                            v-model="selectedBrgy" @change="onSelectBrgy">
                            <option value="" selected>{{ authStore.adminInformation.brgy ?
                    ...
                    <div>
                        ...
                        <input type="text" v-model="authStore.adminInformation.street" placeholder="Type here"
                            class="w-full md:max-w-md md:input-sm xl:input-md input input-bordered" required />
                    </div>
                </div>
                <div class="flex justify-end gap-3 py-3 md:py-0 md:col-span-2">
                    ...
                    <div v-if="isEditing" class="flex gap-2">
                        <button @click="isEditing = !isEditing" type="button" class="btn btn-outline btn-md btn-accent">
                            Cancel
                        </button>
                        <button type="button" @click="updateAdminInfoHandler" class=" btn-md btn btn-primary">
                            Update Profile
                        </button>
                    </div>
