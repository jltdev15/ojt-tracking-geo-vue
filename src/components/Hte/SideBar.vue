<template>
  <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform"
    ...
    <ul class="mt-4">
      ...
      <li class="mb-1 group">
        <router-link @click="toggleList" to="/hte/dashboard/internships"
      ...
      <li class="mb-1 group">
        <router-link :to="{ name: 'ApplicantsList' }" href=""
          class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-[#ae1818] hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
      ...
      <li class="mb-1 group">
        <router-link :to="{ name: 'AcceptedList' }" href=""
          class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-[#ae1818] hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
      ...
      <li class="mb-1 group">
        <router-link :to="{ name: 'InternMonitoring' }" href=""
          class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-[#ae1818] hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
      ...
      <li class="mb-1 group">
        <router-link :to="{ name: 'hte_messenger' }" href=""
