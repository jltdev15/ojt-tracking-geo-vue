      ...
      <template #default>
        ...
        <ul class="p-3 border border-b-2">
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm border-b-2">
            ...
            <div>
              <a
                :class="{ 'underline text-blue-600': item.parentConsentFile }"
                class=""
                target="_blank"
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm border-b-2">
            ...
            <div>
              <a
                :class="{ 'underline text-blue-600': item.internEndorsementPath }"
                class=""
                target="_blank"
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm border-b-2">
            ...
            <div>
              <a
                :class="{ 'underline text-blue-600': item.moaPath }"
                class=""
                target="_blank"
                :href="item.moaPath"
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm">
            ...
            <div>
              <a
                ...
                target="_blank"
                :href="
                  item.firstEndorsementFormPath ? item.firstEndorsementFormPath : '#'
                "
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm">
            ...
            <div>
              <a
                class=""
                target="_blank"
                :href="item.certificationFormPath ? item.certificationFormPath : '#'"
          ...
          <li class="flex items-center justify-between gap-2 p-3 text-sm">
            ...
            <div>
              <a
                class=""
                target="_blank"
                :href="item.internshipAgreementPath ? item.internshipAgreementPath : '#'"
