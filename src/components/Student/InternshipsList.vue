  ...
  <section class="p-3 py-3 mx-auto md:w-10/12 xl:w-11/12">
    ...
    <div class="w-full p-3 bg-white rounded-md shadow-md">
      <header class="flex items-center justify-between p-3">
        <h1 class="p-3 text-3xl font-bold rounded-md bg-primary text-gray-50">Internships Job</h1>
      ...
      <div class="flex items-center justify-center md:h-[50dvh]">
        ...
        <div class="flex flex-col gap-3 rounded-md h-96 w-96 "
          v-if="internStore.isProfileComplete === false && internStore.internshipLists.length">
          <p class="w-full p-3 text-lg font-medium text-center text-gray-900 capitalize card-header"> Complete your
            profile
          ...
          <div class="px-6 pt-3 text-center">
            ...
            <p class="py-1 text-sm text-justify text-gray-400">HTE Prefers to look at profile that are complete. A
              complete profile will enable you to browse internships listing available.</p>
          </div>
          <div class="py-6 mt-auto text-center">
            <router-link class="inline-block p-1 px-2 font-medium bg-green-600 rounded-md text-gray-50"
              :to="{ name: 'intern_profile' }">Let's do it</router-link>
          </div>
